    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="bg-gradient-to-r from-orange-50 to-red-50 border-b border-orange-200 px-4 py-2.5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <button className="p-1 hover:bg-white/60 rounded"><Settings size={15} className="text-gray-500" /></button>
          <button className="p-1 hover:bg-white/60 rounded"><Info size={15} className="text-gray-500" /></button>
        </div>
      ...
      <div className="px-4 py-2 border-b border-gray-200 space-y-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button className="px-3 py-1.5 text-[11px] font-medium text-blue-600 border border-blue-300 rounded hover:bg-blue-50 flex items-center gap-1 transition-colors">
              <Info size={13} />
              More Info
            </button>
            <button className="px-3 py-1.5 text-[11px] font-medium text-blue-600 border border-blue-300 rounded hover:bg-blue-50 flex items-center gap-1 transition-colors">
